...
def crow_id(areaid):
    ...
    head={'Host': 'meishi.meituan.com',
          ...
          'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/66.0.3359.139 Mobile Safari/537.36',
           'Cookie':'__mta=209017773.1534648373617.1534734069958.1534823193214.10"; client-id=a193b9a0-2abf-4662-8f01-b11828b99564; iuuid=99E4976BD8E4E3171C6B7BD9FDCC463EA28C4C6083A87834A36F92B79C404DC7; cityname=%E6%B7%B1%E5%9C%B3; webp=1; _lxsdk_cuid=165502bbc53c8-012d60c809ceda-74286336-d2000-165502bbc53c8; _lxsdk=99E4976BD8E4E3171C6B7BD9FDCC463EA28C4C6083A87834A36F92B79C404DC7; _hc.v=247fa906-38ff-9855-f0de-75c3de8fba28.1534648373; mtcdn=K; ci=30; ta.uuid=1031407697590984708; isUuidUnion=true; __utmz=74597006.1534744524.7.3.utmcsr=blog.csdn.net|utmccn=(referral)|utmcmd=referral|utmcct=/xing851483876/article/details/81842329; _lx_utm=utm_source%3DBaidu%26utm_medium%3Dorganic; IJSESSIONID=17tcp431tnifkjg1ftz62tkxw; latlng=; __utma=74597006.1045348447.1534648368.1534744524.1534823189.8; __utmc=74597006; __utmb=74597006.2.9.1534823192427; i_extend=C_b1Gimthomepagecategory11H__a; uuid=7e26ef29-0dc4-48de-973b-ef65464a29dd; _lxsdk_s=1655a974b6a-a8a-f21-6ec%7C%7C7'
                    }
    p = {'https': 'https://42.242.20.46:2136'}
    ...
    #将数据保存到本地csv
    with open('meituan_id2.csv','a', newline='',encoding='gb18030')as f:
        write=csv.writer(f)
        for i in id_list:
            write.writerow(i)
